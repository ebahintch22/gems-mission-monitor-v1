...
const ACTION = "kobo.media_upload_local";

class KoboMediaUploadLog {
  static create({ manifest, actorUserId, ipAddress, userAgent } = {}) {
    ...
    `).run({
      ...
      action: ACTION,
      entity_type: "kobo_media_local_upload",
      entity_id: manifest?.job_id || null,
...
module.exports = KoboMediaUploadLog;
