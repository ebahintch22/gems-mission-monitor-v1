...
router.get("/archives", requireRole("admin"), missionController.archives);
...
router.post("/:id/archive", requireRole("admin"), missionController.archive);
router.post("/:id/unarchive", requireRole("admin"), missionController.unarchive);
